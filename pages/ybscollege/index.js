...
export default function Ybscollege() {
  return (
    <>
      <div>
          ...
          <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-8">
            <div>
              <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-800 leading-tight mb-6">
                Welcome to YBScollege
              </h1>
              <p className="text-base sm:text-lg text-gray-600 mb-6">
              Established in 2000, YBScollege was recognized as a full-fledged College in April 2003. The College has been awarded eligibility for Central Assistance under Section 12(B) of the UGC Act and has expanded with several facilities, including hostels and a guest house.
              </p>
            ...
            <div className="relative">
              <Image
                src="/img/college2.jpg" // Ensure the image is placed correctly in the public folder
